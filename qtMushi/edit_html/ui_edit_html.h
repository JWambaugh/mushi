...
public:
	...
	tabWidget->addTab(tab, QIcon(QString::fromUtf8(":/img/icon.png")), QApplication::translate("Edit_html", "Edit and View", 0, QApplication::UnicodeUTF8));
	tab_2 = new QWidget();
	...
	stext->setWordWrapMode(QTextOption::NoWrap); //disable word wrap
	hboxLayout->addWidget(stext);


	gridLayout2->addLayout(hboxLayout, 0, 0, 1, 1);

	tabWidget->addTab(tab_2, QIcon(QString::fromUtf8(":/img/view-source.png")), QApplication::translate("Edit_html", "Source View", 0, QApplication::UnicodeUTF8));
	...
	tabWidget->setTabText(tabWidget->indexOf(tab), QApplication::translate("Edit_html", "WYSIWYG", 0, QApplication::UnicodeUTF8));
	tabWidget->setTabText(tabWidget->indexOf(tab_2), QApplication::translate("Edit_html", "Source", 0, QApplication::UnicodeUTF8));
	list_ul->clear();
	list_ul->addItem(QIcon(QString::fromUtf8(":/img/unordered-list.png")), QApplication::translate("Edit_html", "New Item", 0, QApplication::UnicodeUTF8));
	fontsize->clear();
	fontsize->addItem(QApplication::translate("Edit_html", "12", 0, QApplication::UnicodeUTF8));
	fontsize->addItem(QApplication::translate("Edit_html", "15", 0, QApplication::UnicodeUTF8));
